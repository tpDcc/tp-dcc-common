from Qt.QtCore import Qt, Signal, QPoint, QEasingCurve
from Qt.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLineEdit, QMenu, QActionGroup, QAction, QWidgetAction
